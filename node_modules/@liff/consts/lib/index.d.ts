...
export declare const SUB_WINDOW_CANCEL_STATUS = "cancel";
export declare const SUB_WINDOW_SUBMIT_STATUS = "submit";
export declare const SUB_WINDOW_CLOSE_STATUS = "close";
export declare const SUB_WINDOW_ERROR_STATUS = "error";
